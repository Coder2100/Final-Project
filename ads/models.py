...
class BurnerSlide(models.Model):
    ...
    background_svg = models.ImageField(upload_to='customer_profiles/',validators=[image_validation_extension])
    main_message = models.TextField()
    button_message = models.CharField(max_length=30)

    def __str__(self):
        return f"{self.heading}, {self.background_svg}, {self.main_message}, {self.button_message}"
